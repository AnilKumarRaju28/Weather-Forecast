...
const Inputs = ({ setQuery, setUnits }) => {
    ...
    return (
        <div className='flex flex-row justify-center my-6'>
            <div className='flex flex-row w-3/4 ml-40 items-center justify-center space-x-4'>
                <input value={city}
                    onChange={(e) => setCity(e.currentTarget.value)}
                    type="text" placeholder='Enter location' className='text-gray-500 text-xl p-2 w-full rounded-md shadow-xl capitalize focus:outline-none placeholder:lowercase' />
